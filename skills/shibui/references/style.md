...
This is Shibui's default visual profile, implemented by `../assets/css/tokens.css`, `../assets/css/base.css`, and `../assets/css/components.css`. It is separate from the shared [principles](principles.md).
